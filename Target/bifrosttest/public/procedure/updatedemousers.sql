CREATE OR REPLACE PROCEDURE BIFROSTTEST.PUBLIC.UPDATEDEMOUSERS(IN_ID FLOAT, IN_NAME VARCHAR(16777216), IN_BIRTHDAY DATE, IN_CITYCODE FLOAT, IN_EMAIL VARCHAR(16777216))
...
$$
   ...
   EXEC(`UPDATE DemoUsers SET
  Name = ?,
  Birthday= /*** MSC-WARNING - MSCEWI1020 - CUSTOM UDF 'JSDATE_UDF' INSERTED. **/*
 PUBLIC.JSDATE_UDF(?),
  CityCode = ?,
  Email = ?
